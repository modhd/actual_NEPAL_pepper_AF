...
### Chance events
Our two water regime scenarios were modelled using the ```decisionSupport::chance_event()```function. A chance of .. percent was assumed that water competition would occur, leading to lower yields and highe rirrigation costs.
