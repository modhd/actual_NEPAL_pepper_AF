...
mono_nutrient_saved <- mono_nutrient* fertilizer_price  #Monetary value of fertilizer bags saved in rubber monoculture

AF_nutrient <- vv(var_mean = AF_nutrient,
                            var_CV = var_AF_nutrient,
                            n = n_years)

AF_nutrient_saved <- AF_nutrient * fertilizer_price  #Monetary value of fertilizer bags saved in rubber and pepper system  
