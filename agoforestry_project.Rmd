...
2. insert the ```{asis, echo=FALSE}``` optin in the r-chunk where you want to cite (see example below).
...
```{r inputtable, caption= "Input variables as used in the decision analysis.", echo=FALSE, warning=FALSE}
library(knitr)
options(scipen = 999)
